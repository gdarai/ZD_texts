...
**Mapa** je rozložená uprostřed stolu. Na ní stojí vaše figurky a leží žetony příšer a vítězných bodů. Vše, co je na mapě, kde kdo stojí a jaké příšery kde jsou, je veřejné.

**Dobírací balíčky** karet leží vedle mapy. Je tu lícem dolů šest dobíracích balíčků. Zbraně: kopí, palice, meče a luky, a dále: úkoly a předměty. Dál je tu lícem nahoru veřejná nabídka úkolů a odkládací balíček zahraných karet.

**(Každý hráč) Na ruce** držíte karty zbraní, předmětů a úkolů. Všechny jsou tajné, neukazujte je, pokud to pravidla výslovně nenařídí. Na ruce máte navíc dvě **karty příběhu**. Jedna se jmenuje Povolání a druhá Jsem EPIC.

![ZADNÍ STRANY KARET](rulesImg/02_zadniStrany.PNG) 

**(Každý hráč) Na stole** před sebou máte každý svou hromádku získaných vítězných bodů a karet splněných úkolů. A žetony poražených příšer - trofeje.
...
Vezměte karty nápověd a dejte je na dobře dosažitelné místo. Obsahují shrnutí nejdůležitějších pravidel hry, abyste si hlavní pravidla jednodušeji osvojili. Jsou rozděleny podle kapitol, kterých se týkají.

Vyberte začínajícího hráče, bude hrát první. Bude mít oproti ostatním malou výhodu, proto vyberte někoho méně zkušeného. Hrajte po směru hodinových ručiček, takže hráč napravo od začínajícího bude hrát poslední. Jako kompenzaci bude velet stavbě mapy. Tady je pár možných tvarů mapy, jeden si vyberte.

![TVARY MAPY + vysvětlivky](rulesImg/04_tvarMapy.PNG)

![ZÁKLADNÍ A SPECIÁLNÍ POLE MAPY](rulesImg/05_dilkyMapy.PNG)

![KAM MINIATURY](rulesImg/09_mapaSpecial.PNG)
Velitel mapy vezme 5 speciálních polí (hrad, dvě skály a dva starty) a odloží je stranou. Zbytek polí zamíchá. Speciální pole rozloží podle obrázku mapy. Z ostatních polí postaví vybraný tvar. Pole pokládá lícem nahoru a při pokládání každé pole náhodně otočí. Po sestavení mapy mu jedno pole přebyde. Vrátí ho do krabice, nebude v této hře potřeba. Pak se velitel podívá, jak jsou umístěné hory, a zkontroluje, zda není nějaké pole zcela nedostupné. Chodí se vodorovně a svisle, a přes hory chodit nejde. Pokud se na nějaké pole nedá dojít od startu nebo teleportu, je třeba to opravit. Velitel mapy vybere, které pole se v takovém případě pootočí. Nakonec přidá miniatury skal a hor.

X: Mapa má působit náhodně. Pokud bys orientaci polí mapy srovnával, aby byly otočené všechny stejně, hře to ublíží.

X: Hru připravujete všichni společně, ale při stavbě mapy rozhoduje velitel mapy.

X: Po mapě chodíš vodorovně a svisle a nikdy ne přes skály a hory. Vycházíš ze startu či od teleportu. Zkontroluj, zda jde na každé pole dojít. Pokud ne, oprav to tím, že nějaké otočíš.

![tabulka: NEDOVOLENÉ SITUACE MAPY](rulesImg/05a_chybyMapy.PNG)

Tahejte z váčku náhodně příšery. Na každé pole vylosujte jednu. Výjimkou je hrad, kde jsou příšery dvě. Příšery se neumísťují na pole start, skála, vesnice a teleport (pole mají symbol "Bez příšery"). Na každou příšeru položte vítězný bod.

![SYMBOLY NA POLÍCH MAPY](rulesImg/06_symbolyMapy.PNG)
...
Každý si doberte jednu kartu úkolu a jednu kartu předmětu. Dále si doberte dvě zbraně. Berte si je postupně, od začínajícího hráče. Můžete brát z jakých balíčků zbraní chcete, klidně každou z jiného.

H: Cesta za slávou je trnitá. Doufám, že už teď víš, že luk na kostlivce nestačí.

X: Často se vyplatí vzít si druhou zbraň, až když víš, jakou zbraň sis dobral jako tu první.

![UKÁZKOVÁ POČÁTEČNÍ RUKA](rulesImg/07_ruka.PNG)

Z dobíracího balíčku úkolů otočte tři vrchní karty. Vyložte je jako veřejnou nabídku. Tím je hra připravená začít.

## Tah hráče

Tah se skládá z posouvání figurky po mapě a hraní karet z ruky. Na ruce máte vždy nanejvýš dvě zbraně, dvě karty příběhu co jste dostali na začátku hry, a libovolné množství karet úkolů a předmětů. Hrajte postupně. Vždy hraje jeden hráč a ostatní mu do jeho tahu nezasahují. Což ale neznamená, že mu do toho nemohou mluvit. V dalších kapitolách je tah rozepsán podrobněji, ale teď shrňme to nejdůležitější.
...
**2) Vybavení**. Přišli jste do vesnice nebo do věže? V takovém případě si nabíráte karty úkolů a předmětů (vždy po jedné kartě předmětu a úkoly jen ve vesnici). Těchto karet můžete mít na ruce, narozdíl od zbraní, kolik chcete.

**3) Dobrání karet zbraní**. Dobíráte vždy do dvou zbraní na ruce. Vyberte si zbraň podle toho, co je nakreslené na poli mapy, na které jste vstoupili. Doberte si kartu z příslušného balíčku. Pokud dobíráte i druhou zbraň, tu si vyberte libovolnou.

**4) Plnění úkolů**. Po dobrání zbraní jsou na řadě úkoly. Pokud splňujete podmínky některého z úkolů (například máte potřebné trofeje), můžete si ho teď vyložit před sebe, a mít ho odteď splněný. Každý splněný úkol má cenu jednoho vítězného bodu. Pokud se uvolnilo místo ve veřejné nabídce úkolů, doplňte ji nakonec opět na tři karty.

**5) Vítězství**. Tím tah jednoho hráče končí. Zkontrolujte, kolik máte vítězných bodů a splněných úkolů (a karet příběhu). Jejich součet je vaše skóre. Pokud jste ještě nedosáhli vítězného množství (pro 2/3/4 hráče 12/10/9 bodů), pokračuje hra tahem dalšího hráče.

## Tah 1A) Pohyb

Základem tahu je posunutí figurky po mapě. S figurkou táhněte o jedno pole vodorovně nebo svisle. Nemůžete táhnout přes hory, to je nepřekonatelná překážka. Ostatní figurky hrdinů vám nepřekáží, na poli vás může stát víc. Při každém pohybu musíte zahodit zbraň, i když vstupujete na pole bez příšery. Pokud na poli příšera je, musí být zbraň taková, aby příšeru porazila, viz "Příšery a zbraně".
...
X: Hory nepřekáží, pokud máš kouzlo létání, viz "Kouzla". Zato skála, ta překáží vždy.
...
**Pole teleport** je výjimečné. Na něm nemůžete nikdy stát a nikdy na něm není příšera. Ale když stojíte vedle teleportu, můžete jedním krokem projít teleportem, na libovolné pole, sousedící se kterýmkoliv teleportem na mapě. Jako by ta pole byla hned vedle sebe. Na teleport (a ani z něj) stále nesmíte jít přes hory.

X: I hory na poli teleport jde přeletět kouzlem létání.
...
X: Opravdu přes skálu jít nemůžeš. Ani s kouzlem létání.

**Pole hrad** se tyčí nad okolní krajinou. Prastará zřícenina, na které spolu straší hned dvě příšery. Zlikvidujte je a čekají vás dva vítězné body. Ale potřebujete porazit obě příšery naráz. Nejde porazit jen jednu. Musíte je porazit obě zároveň. Přesto stále jednou zbraní porazíte jen jednu příšeru. Zde ale můžete k boji použít naráz obě zbraně, které máte.

X: To znamená, že na hrad můžeš pouze, pokud máš zbraně na poražení obou příšer, které tam jsou. Na každou zbraň smíš použít kouzlo, ale není to povinné. Na tomto poli jsou příšery tak blízko u sebe, že budeš bojovat s oběma zároveň, i kdybys žádné kouzlo nepoužil.
...
![obrázek: DOPLNOVANI PRISER](rulesImg/10a_doplnovaniPriser.PNG)

Když odpočíváte, máte čas si přečíst poštu a dozvědět se novinky. Teď si tedy můžete vyměnit jeden úkol z ruky za nový. Musíte k tomu nějaký na ruce mít a nejprve ho zahodit. Pak si teprve doberte nový, z dobíracího balíčku úkolů.

Když je vše připraveno, vyberte si, kde chcete odpočívat a ihned se tam přesuňte. Buď zůstaňte tam, kde jste byli, nebo se přesuňte na libovolné pole start.

X: I když odpočíváš, hraješ ostatní fáze tahu. Například tedy můžeš doplnit vybavení, pokud budeš odpočívat ve vesnici nebo u věže.

X: Přestože odpočíváš, můžeš plnit úkoly. I ty co jsi teď nově získal na ruku.
...
H: Znal jsem jednoho lovce. Přišel do vesnice a trvalo mu tři dny, než se probral nabídkou místního obchodu.

**Ve věži i ve vesnici** si doberte novou kartu předmětu.

**Ve vesnici** navíc proberte vývěsku s úkoly.
- Jednu kartu z vyložené nabídky úkolů, nebo horní z dobíracího balíčku, si vezměte na ruku jako svůj další úkol.
...
H: A hele, tady píšou "Hledá se hrdina". Tenhle letáček ostatní vidět nemusí. Vezmu si ho, děkuji.

X: Z veřejné nabídky tedy můžeš ve vesnici odstranit až dvě karty úkolů. Nabídka se znovu doplní před tahem příštího hráče.

X: Na počet předmětů ani karet úkolů v ruce není žádný limit. Můžeš jich mít, kolik chceš.

X: Máš často ve vesnici nutkání nabídku úkolů hned doplňovat? Klidně, ale doplň je lícem dolů, a nech až příštího hráče, ať si je před svým tahem otočí.

H: Je až zvláštní, jak z vývěsních cedulí rychle mizí ty snadnější úkoly. Ale že by někdo sundal ten nesplnitelný úkol "Ulovte draka", to ne.
...
Po dobrání zbraní musíte také zahodit nadbytečné trofeje: žetony poražených příšer. Můžete si nechat maximálně tři. Zvažte, které se vám ještě budou hodit k plnění úkolů a které už ne, viz "Tah 4) Plnění úkolů".
...
X: Mezi vámi nikdy nesmí být hory. 
...
Pro úkol **"zažeň ke skále"** (typ úkolu **Bariéra**) je potřeba, abyste stáli vedle příšery a těsně za ní byla skála nebo hory.

X: Pozor! Úkoly plníš až na konci tahu, počítá se tvoje pozice na mapě na konci tahu. Že jsi někudy proběhl, nebo tam byl na začátku tahu, pro splnění úkolu nestačí.
...
H: Se slávou to je jednoduché. Čím více nás po okolí pobíhá, tím méně slávy stačí jednomu, aby nás místní už měli opravdu dost.

## Kouzla

Magie je chaos. Kouzla mění pravidla. Kdo je ovládne, může ovládnout celou hru. Je dobré jim pořádně porozumět.

Kouzla jsou buď vázaná na zbraň, nebo volná. Vázaná kouzla jsou nakreslená přímo na kartě zbraně a působí jen na tuto zbraň. Volná kouzla jsou nakreslená na kartě předmětu. Taková kouzla pak působí na zbraň, se kterou předmět použijete. Kouzla používáte při pohybu po mapě. Uděláte krok po mapě, použijete zbraň a s ní můžete použít kouzlo. Žádné kouzlo není povinné. Každou zbraň jde použít, jako by kouzlo neměla. Naopak, žádnou zbraň nejde použít s více než jedním kouzlem. Žádné kouzlo vázané na zbrani nejde přenést na jinou zbraň. Pokud použijete se zbraní kouzlo z předmětu, jednoduše odhodíte jak zbraň, tak předmět na odkládací balíček.

![obrázek: UKÁZKA ZBRANĚ S KOUZLEM A PŘEDMĚTU](rulesImg/15_kouzlo.PNG)

X: Zbraň, která má na sobě kouzlo, můžeš použít, jako by žádné neměla.
...
X: Odteď ty stojíš tam kde stál on a on je tam co jsi byl ty. Také si myslíš, že tím jde někoho dostat do pěkných potíží?

X: Pozor, nejdřív se prohazujete a až pak zaútočíš na příšeru. Nikdy ne naopak.

X: To znamená, že vedle jiného hráče musí být pole, na které s touto zbraní můžeš jít.

**Kouzlo vábení** říká: "Přilákej příšeru z jiného pole". Vyberte libovolnou příšeru na mapě, kterou jde zvolenou zbraní porazit. Dejte jí na pole kam teď zaútočíte. Pokud tam už nějaká příšera je, tak je vyměňte.
...
X: Jde přivábit příšeru i na pole co má být prázdné, jako je start nebo vesnice. Stejně jí hned zlikviduješ.

H: Dokonce, i když tam stojí jiný hrdina. Aspoň uvidí, jak se tahle práce dělá.

X: Příšeru musíš přivábit. Nemůžeš jí jen odvábit pryč a „zapíchnout“ místo ní prázdné pole.
...
**Kouzlo létání** říká: "Zaútoč přechodem přes hory". Tohle kouzlo mění způsob, jak můžete chodit po mapě. Při tomto jednom útoku zbraní můžete ignorovat případné hory v cestě.

X: Ale jen pro tento útok. Pro plnění úkolů tam už ty hory opět jsou.
...
H: Epické je jednou očarovanou zbraní, jedním krokem, k poražení jedné příšery, přeletět dvoje hory.

## Jak hrát víc her

EPIC není strategická hra na celý večer. Je celkem hodně náhodná a měla by se hrát víckrát za sebou.
...
**Můžete dohrávat** poslední kolo. Když první z vás získá body potřebné k vítězství, dohrajete až k začínajícímu hráči. Pokud má nakonec víc hráčů nejvíc vítězných bodů, vyhraje ten, kdo má víc splněných úkolů.

H: Všiml sis, že jména splněných úkolů dělají titul, kterým ti místní budou odteď říkat?

H: Dohrávání není v duchu této hry, ale jde to. Není to na škodu. A někteří to opravdu mají radši. Tak prosím, tady to máš, jako volitelné pravidlo.

## Slovo závěrem

Naše hra se snaží překlenout ten most mezi hráči, kteří rádi plánují a hráči, kteří chtějí hlavně vzít palici a něco s ní EPICky praštit. Hru jsme vyvíjeli, připravovali a testovali dva roky. Byla to skvělá jízda a ohromné množství legrace. Tak vám přejeme, ať baví i vás.

V této hře jde hodně plánovat a bez pochyby to má vliv na výsledek. Míra náhody a chaosu je však tak velká, že šanci vyhrát máte všichni. A přesně tak jsme to chtěli. Tak ti, hrdino, přeju, ať se ti hra líbí a ať jsi dnes nejvíc EPIC právě ty.

H: Copak v tom balíčku luků není jedinej luk?!

H: Když budu vábit příšery rovnou do vesnice, určitě budu brzy velmi slavná.

H: Nechali jste mi jen jedinou zbraň lumpové, ale já ten hrad stejně dobiju. Ona je to totiž tvrdá bomba!

H: Neuvěříte, co jsem dneska viděl. Proběhla tudy barbarská válečnice. Šel jí kouř z uší a rozbila si meč o výlohu v obchodě s kouzelnými předměty. Asi jí to nestačilo, tak se chopila obrovského kladiva a s křikem běžela dál, kamsi za humna.
