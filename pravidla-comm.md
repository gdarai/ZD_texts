...
## Myšlenka hry (ucelenost 4, styl 4)

== Asi bych se  drzel standardniho terminu hrac misto hrdina.
== Poslední věta by mohla být něco jako nejslavnější hrdina zvitezi ať to zní vic epic ✨️
== Zaroven bych se asi snazil pouzit vo nejprimocarejsi text, kde mene je vice. Napr zbrane nemusi byt legendarni. Proste to jsou jen zbrane. Jinak mi to prijde ok.
...
## Herní prvky (ucelenost 4, styl 3,5)

== V mapa máš "Žetony slávy na mapě zatím nikomu nepatří. Získá je ten z vás, který se k nim dostane jako první."To by spis uz melo byt v pravidlech hry ne v úvodu mam pocit
== Vyhodil bych “co je ve hře”. Použil bych něco jako “Herní prvky”.
== Říkám si, jestli by nešla udělat stop motion animace, která by rovnou kombinovala herní prvky s logikou/setupem hry.
...
## Od zbraně k příšeře (celkove za 4)

== Zbraně jsou v každém balíčku namíchané. Tahle věta by tam asi neměla být prijde mi navíc a matoucí 
== Nebyl tento odstavec již v prvním dotazníku pravidel ?
== Jinak good, nvm jestli by tady nemělo být napsáno zbran kouzlo interakce ale asi spíš ne takže dobrý 
== Nepopisuje to zbraně ale něco co uz bylo nebo sem zmaten ja ?
...
## Příprava hry (styl 4,5)

== Hrdina a velitel, nebude se to v textu plest? Podle mne je lepsi hovorit o hraci, ne o hrdinovi. Neni zeton slavy proste vitezny zeton/bod? Velitel mapy by pak mohl bxt spravce mapy.
== Kdyz pises “udelej”/“vylosuj” a podobne, mluvis ke ctenari jako hraci. Ale to neni zadna role ve hre. Cekal bych text ve 3.osobe jednotneho i mnoznehl cisla. Hrac udela, hraci jeden po druhem udelaji… H:?, X:? je oznaceni pro koho?
...
## Tah hrdiny (uzitecnost 3,5 jinak 4)

== Neni napsáno jak se pohnout na prázdné pole neco jako kdyz neni příšera zahod zbran a pohni se, ted bych z toho pochopil ze můžeš chodit jen po polích kde sou příšery ještě 
== Pouzivani pojmu nemrtvy bych nechapal, kdyz bys mi nerekl, ze se to pouziva. Mne takove pojmy matou. To ze je palice na zombiky je nekde napsano?
== 
== 
...
## Fáze tahu 1a - Pohyb (celkem 4,5)

== Asi good mohl by jsi dodat ze ji porazis kdyz vztoupis na políčko s zbraní co jí porazí, ok koukam ze to tam je v 6a 😅
== X: To, že tu nikdy příšery nebudou, není technicky vzato pravda. Na každé políčko, tedy i sem, můžeš přivolat příšeru kouzlem vábení. Na teleport to třeba nejde ne? Možná tyto vyjímky, že někde něco jse a jinde zase ne ta pravidla komplikují. Ideální pro jednoduchost by bylo mít co nejvíce obecných pravidel, která platí vždy.
== X: Ať je to úplně jasné, za průchod teleportem odevzdáváš jednu zbraň a to podle toho nového pole na které vystoupíš. To přece záleží, jestli tam je příšera. Ne jaké je to pole. Navíc to nechápu, proč bys za projití teleportu musel odhodit o zbraň navíc. Ta formulace má více vysvětlení.
...
## Fáze tahu 1b - Odpočinek (v pokoji, celkem 4,5)

== Uvidime, jak to bude vypadat jako celek. Mozna bude potreba sjednotit “literarni” styl.
...
## Fáze tahu 3 - Dobrání karet zbraní (delka a ucelenost za 4,5)

== Nevím jestli kouzlo krádeže je nutné zde zmiňovat 
== Možná bych dodal ze můžeš mít neomezený počet úkolů na ruce
== Byl jsem schopný povhopit vše. Gramatickou strànku jsem neresil
